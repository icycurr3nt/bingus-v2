    ...
    <div class="row align-items-start">
        ...
        <div class="col-8 text-white" style={{"background-color": "#313537"}}>
            <div class="container">
                ...
                <img src="assets/images/titus.png" alt="Titus Nguyen" class="img-fluid rounded mx-auto d-block"/>
                <div class="container">
                    <p class="mt-3">
                    ...
                    <img src="assets/images/penguin.jpeg" alt="His Favorite Animal: The Penguin" class="img-fluid rounded mx-auto d-block mb-5" style={{"width": "75%"}}/>
                </div>
            </div>
            ...
            <div class="container mt-4">
                ...
                <img src="assets/images/danica.jpg" class="img-fluid rounded mx-auto d-block" style={{"width": "50%"}} alt="Danica Van Alstine"/>
                <div class="container">
                    <p class="mt-3">
                    ...
                    <img src="assets/images/komodo.png" alt="Her Favorite Animal: The Komodo Dragon" class="img-fluid rounded mx-auto d-block" style={{"width":"75%"}}/>
                </div>
            </div>
            ...
            <div class="container mt-4">
                ...
                <img src="assets/images/alan.jpg" class="img-fluid rounded mx-auto d-block" style={{"width": "50%"}} alt="Alan Zhang"/>
                <div class="container">
                    <p class="mt-3">
                    ...
                    <img src="assets/images/animalA.jpg" alt="His Favorite Animal: The Nightingale" class="img-fluid rounded mx-auto d-block" style={{"width": "75%"}}/>
                </div>
            </div>
            ...
            <div class="container mt-4">
                ...
                <img src="assets/images/nicholas.jpg" class="img-fluid rounded mx-auto d-block" style={{"width": "50%"}} alt="Nicholas Li"/>
                <div class="container">
                    <p class="mt-3">
                    ...
                    <img src="assets/images/animalN.jpg" alt="His Favorite Animal: The Panda" class="img-fluid rounded mx-auto d-block" style={{"width": "75%"}}/>
                </div>
            </div>
